...
Rid_entry = tk.Label(frame, text="Registration ID", font = ("Poppins", 12))
Rid_entry.grid(
...
Sname_entry = tk.Label(frame, text="Student Name", font = ("Poppins", 12))
Sname_entry.grid(
...
Course_entry = tk.Label(frame, text="Course", font = ("Poppins", 12))
Course_entry.grid(
    row=2, column=0, padx=5, pady=5
)

#Year Level Entry
Year_entry = tk.Label(frame, text="Year Level", font = ("Poppins", 12))
Year_entry.grid(
...
Ename_entry = tk.Label(frame, text="Event Name", font = ("Poppins", 12))
Ename_entry.grid(
